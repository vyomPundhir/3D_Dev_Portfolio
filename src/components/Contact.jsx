...
const Contact = () => {
  ...
  return (
    <div id='contactus' className='m-0 p-0 box-border snap-center w-full h-screen bg-black'>
      <section className='w-full h-full flex justify-center gap-[120px]'>
        ...
        <div className="left basis-1/2 flex justify-end items-center">
          ...
          <form ref={ref} className="form w-[500px] flex flex-col gap-[25px] justify-center items-start" onSubmit={handleSubmit}>
            ...
            <button className='w-full bg-transparent text-[#1eff00] text-[22px] font-[700] border-[3px] border-[#1eff00] cursor-pointer rounded-[10px] p-[20px] hover:shadow-[0px_0px_30px_5px_#1eff00]  hover:text-[#1eff00] transition ease-in-out duration-500' type='submit'>Send</button>
            {success &&
